...
//        this->dgs.decode("../population/childbaby4.txt", params);
//
 ...
 *  @param LS - Lsystem structure containing the alphabet.
 */
void Genome::decodeGeneticString(std::string genome_direct,std::map<std::string, double> params) {

    try {
        this->dgs = DecodedGeneticString();
        this->dgs.decode(genome_direct, params);
 ...
 *  @param LS - Lsystem structure containing the alphabet.
 */
void Genome::developGenomeIndirect(int argc, char* argv[], std::map<std::string, double> params, std::string genome_direct, int generation, std::string path) {

    // decodes the final genetic-string into a tree of components
    this->decodeGeneticString(genome_direct, params);
